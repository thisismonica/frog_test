...
@.str1 = private unnamed_addr constant [3 x i8] c"a2\00", align 1
...
entry:
  ...
  %a2 = alloca %struct.Node_t*
  %"alloca point" = bitcast i32 0 to i32
  %1 = load %struct.Node_t*** %a1, align 8, !dbg !82
  %2 = bitcast %struct.Node_t** %1 to i8*, !dbg !82
  call void @klee_make_symbolic(i8* %2, i64 8, i8* getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !82
  %3 = load %struct.Node_t** %a2, align 8, !dbg !84
  %4 = bitcast %struct.Node_t* %3 to i8*, !dbg !84
  call void @klee_make_symbolic(i8* %4, i64 8, i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !84
  %5 = load %struct.Node_t*** %a1, align 8, !dbg !85
  %6 = load %struct.Node_t** %a2, align 8, !dbg !85
  call void @remove_from_list(%struct.Node_t** %5, %struct.Node_t* %6) nounwind, !dbg !85
  store i32 0, i32* %0, align 4, !dbg !86
  %7 = load i32* %0, align 4, !dbg !86
  store i32 %7, i32* %retval, align 4, !dbg !86
  %retval1 = load i32* %retval, !dbg !86
  ret i32 %retval1, !dbg !86
}
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"remove_from_list", metadata !"remove_from_list", metadata !"remove_from_list", metadata !1, i32 8, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.Node_t**, %
...
!7 = metadata !{i32 589846, metadata !1, metadata !"Node_t", metadata !1, i32 6, i64 0, i64 0, i64 0, i32 0, metadata !8} ; [ DW_TAG_typedef ]
!8 = metadata !{i32 589843, metadata !1, metadata !"Node", metadata !1, i32 2, i64 192, i64 64, i64 0, i32 0, null, metadata !9, i32 0, null} ; [ DW_TAG_structure_type ]
!9 = metadata !{metadata !10, metadata !12, metadata !14}
!10 = metadata !{i32 589837, metadata !8, metadata !"value", metadata !1, i32 3, i64 32, i64 32, i64 0, i32 0, metadata !11} ; [ DW_TAG_member ]
!11 = metadata !{i32 589860, metadata !1, metadata !"int", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!12 = metadata !{i32 589837, metadata !8, metadata !"next", metadata !1, i32 4, i64 64, i64 64, i64 64, i32 0, metadata !13} ; [ DW_TAG_member ]
!13 = metadata !{i32 589839, metadata !1, metadata !"", metadata !1, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !8} ; [ DW_TAG_pointer_type ]
!14 = metadata !{i32 589837, metadata !8, metadata !"prev", metadata !1, i32 5, i64 64, i64 64, i64 128, i32 0, metadata !13} ; [ DW_TAG_member ]
!15 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 26, metadata !16, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!74 = metadata !{i32 10, i32 0, metadata !75, null}
!75 = metadata !{i32 589835, metadata !0, i32 8, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!76 = metadata !{i32 12, i32 0, metadata !75, null}
!77 = metadata !{i32 15, i32 0, metadata !75, null}
!78 = metadata !{i32 16, i32 0, metadata !75, null}
!79 = metadata !{i32 18, i32 0, metadata !75, null}
!80 = metadata !{i32 19, i32 0, metadata !75, null}
!81 = metadata !{i32 21, i32 0, metadata !75, null}
!82 = metadata !{i32 31, i32 0, metadata !83, null}
!83 = metadata !{i32 589835, metadata !15, i32 26, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!84 = metadata !{i32 32, i32 0, metadata !83, null}
!85 = metadata !{i32 34, i32 0, metadata !83, null}
