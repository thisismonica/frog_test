...
bb1:                                              ; preds = %entry
  %4 = icmp eq i32 %3, 0, !dbg !68
  br i1 %4, label %bb2, label %bb3, !dbg !68

bb2:                                              ; preds = %bb1
  %5 = load i32* %a_addr, align 4, !dbg !69
  store i32 %5, i32* %num2, align 4, !dbg !69
  br label %bb3, !dbg !69
...
bb3:                                              ; preds = %bb2, %bb1, %bb
  ...
  %retval4 = load i32* %retval, !dbg !70
  ret i32 %retval4, !dbg !70
}
...
entry:
  ...
  call void @klee_make_symbolic(i8* %a11, i64 4, i8* getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !71
...
!6 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 23, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!68 = metadata !{i32 7, i32 0, metadata !66, null}
!69 = metadata !{i32 9, i32 0, metadata !66, null}
!70 = metadata !{i32 17, i32 0, metadata !66, null}
!71 = metadata !{i32 25, i32 0, metadata !72, null}
!72 = metadata !{i32 589835, metadata !6, i32 23, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!73 = metadata !{i32 27, i32 0, metadata !72, null}
!74 = metadata !{i32 28, i32 0, metadata !72, null}
