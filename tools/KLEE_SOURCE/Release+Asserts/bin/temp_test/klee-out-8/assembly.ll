...
entry:
  ...
  store i32 100, i32* %a_addr, align 4, !dbg !65
  %1 = load i32* %a_addr, align 4, !dbg !67
  %2 = icmp sgt i32 %1, 0, !dbg !67
  %3 = load i32* %a_addr, align 4, !dbg !68
  br i1 %2, label %bb, label %bb1, !dbg !67

bb:                                               ; preds = %entry
  store i32 %3, i32* %num1, align 4, !dbg !68
  %4 = load i32* %a_addr, align 4, !dbg !69
  store i32 %4, i32* %0, align 4, !dbg !69
  br label %bb6, !dbg !69

bb1:                                              ; preds = %entry
  %5 = icmp eq i32 %3, 0, !dbg !70
  %6 = load i32* %a_addr, align 4, !dbg !71
  br i1 %5, label %bb2, label %bb3, !dbg !70

bb2:                                              ; preds = %bb1
  store i32 %6, i32* %num2, align 4, !dbg !71
  br label %bb5, !dbg !71

bb3:                                              ; preds = %bb1
  %7 = icmp sgt i32 %6, 13, !dbg !72
  br i1 %7, label %bb4, label %bb5, !dbg !72

bb4:                                              ; preds = %bb3
  %8 = load i32* %a_addr, align 4, !dbg !73
  store i32 %8, i32* %num3, align 4, !dbg !73
  br label %bb5, !dbg !73

bb5:                                              ; preds = %bb4, %bb3, %bb2
  %9 = load i32* %a_addr, align 4, !dbg !74
  store i32 %9, i32* %0, align 4, !dbg !74
  br label %bb6, !dbg !74

bb6:                                              ; preds = %bb5, %bb
  %10 = load i32* %0, align 4, !dbg !69
  store i32 %10, i32* %retval, align 4, !dbg !69
  %retval7 = load i32* %retval, !dbg !69
  ret i32 %retval7, !dbg !69
}
...
entry:
  ...
  %result = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %a11 = bitcast i32* %a1 to i8*, !dbg !75
  call void @klee_make_symbolic(i8* %a11, i64 4, i8* getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !75
  %1 = load i32* %a1, align 4, !dbg !77
  %2 = call i32 @loop(i32 %1) nounwind, !dbg !77
  store i32 %2, i32* %result, align 4, !dbg !77
  store i32 0, i32* %0, align 4, !dbg !78
  %3 = load i32* %0, align 4, !dbg !78
  store i32 %3, i32* %retval, align 4, !dbg !78
  %retval2 = load i32* %retval, !dbg !78
  ret i32 %retval2, !dbg !78
}
...
!1 = metadata !{i32 589865, metadata !"integer_overflow4.c", metadata !"/home/qirong/Desktop/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"integer_overflow4.c", metadata !"/home/qirong/Desktop/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!3 = metadata !{i32 589845, metadata !1, metadata !"", metadata !1, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !4, i32 0, null} ; [ DW_TAG_subroutine_type ]
!4 = metadata !{metadata !5, metadata !5}
!5 = metadata !{i32 589860, metadata !1, metadata !"int", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!6 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 25, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!65 = metadata !{i32 4, i32 0, metadata !66, null}
!66 = metadata !{i32 589835, metadata !0, i32 2, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!67 = metadata !{i32 5, i32 0, metadata !66, null}
!68 = metadata !{i32 6, i32 0, metadata !66, null}
!69 = metadata !{i32 7, i32 0, metadata !66, null}
!70 = metadata !{i32 9, i32 0, metadata !66, null}
!71 = metadata !{i32 11, i32 0, metadata !66, null}
!72 = metadata !{i32 14, i32 0, metadata !66, null}
!73 = metadata !{i32 15, i32 0, metadata !66, null}
!74 = metadata !{i32 19, i32 0, metadata !66, null}
!75 = metadata !{i32 28, i32 0, metadata !76, null}
!76 = metadata !{i32 589835, metadata !6, i32 25, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!77 = metadata !{i32 31, i32 0, metadata !76, null}
!78 = metadata !{i32 32, i32 0, metadata !76, null}
