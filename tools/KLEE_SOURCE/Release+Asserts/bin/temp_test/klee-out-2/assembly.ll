...
@.str = private unnamed_addr constant [11 x i8] c"num2 = %d\0A\00", align 1
...
entry:
  ...
  %2 = icmp sgt i32 %1, 0, !dbg !65
  %3 = load i32* %a_addr, align 4, !dbg !67
  br i1 %2, label %bb, label %bb1, !dbg !65

bb:                                               ; preds = %entry
  store i32 %3, i32* %num1, align 4, !dbg !67
  br label %bb2, !dbg !67

bb1:                                              ; preds = %entry
  store i32 %3, i32* %num2, align 4, !dbg !68
  %4 = load i32* %num2, align 4, !dbg !69
  %5 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([11 x i8]* @.str, i64 0, i64 0), i32 %4) nounwind, !dbg !69
  br label %bb2, !dbg !69

bb2:                                              ; preds = %bb1, %bb
  %6 = load i32* %a_addr, align 4, !dbg !70
  store i32 %6, i32* %0, align 4, !dbg !70
  %7 = load i32* %0, align 4, !dbg !70
  store i32 %7, i32* %retval, align 4, !dbg !70
  %retval3 = load i32* %retval, !dbg !70
  ret i32 %retval3, !dbg !70
}
...
entry:
  ...
  %result = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %a11 = bitcast i32* %a1 to i8*, !dbg !71
  call void @klee_make_symbolic(i8* %a11, i64 4, i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !71
  %1 = load i32* %a1, align 4, !dbg !73
  %2 = call i32 @loop(i32 %1) nounwind, !dbg !73
  store i32 %2, i32* %result, align 4, !dbg !73
  store i32 0, i32* %0, align 4, !dbg !74
  %3 = load i32* %0, align 4, !dbg !74
  store i32 %3, i32* %retval, align 4, !dbg !74
  %retval2 = load i32* %retval, !dbg !74
  ret i32 %retval2, !dbg !74
}
...
!1 = metadata !{i32 589865, metadata !"integer_overflow.c", metadata !"/home/qirong/Desktop/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"integer_overflow.c", metadata !"/home/qirong/Desktop/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!3 = metadata !{i32 589845, metadata !1, metadata !"", metadata !1, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !4, i32 0, null} ; [ DW_TAG_subroutine_type ]
!4 = metadata !{metadata !5, metadata !5}
!5 = metadata !{i32 589860, metadata !1, metadata !"int", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!6 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 20, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!68 = metadata !{i32 8, i32 0, metadata !66, null}
!69 = metadata !{i32 9, i32 0, metadata !66, null}
!70 = metadata !{i32 14, i32 0, metadata !66, null}
!71 = metadata !{i32 22, i32 0, metadata !72, null}
!72 = metadata !{i32 589835, metadata !6, i32 20, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!73 = metadata !{i32 24, i32 0, metadata !72, null}
!74 = metadata !{i32 25, i32 0, metadata !72, null}
