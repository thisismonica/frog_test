...
entry:
  ...
  %4 = bitcast %struct.Node_t** %3 to i8*, !dbg !85
  call void @klee_make_symbolic(i8* %4, i64 8, i8* getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !85
  %5 = call noalias i8* @malloc(i64 24) nounwind, !dbg !86
  %6 = bitcast i8* %5 to %struct.Node_t*, !dbg !86
  store %struct.Node_t* %6, %struct.Node_t** %a1, align 8, !dbg !86
  %7 = load %struct.Node_t** %a1, align 8, !dbg !87
  %8 = bitcast %struct.Node_t* %7 to i8*, !dbg !87
  call void @klee_make_symbolic(i8* %8, i64 24, i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !87
  %9 = load %struct.Node_t*** %a0, align 8, !dbg !88
  %10 = load %struct.Node_t** %a1, align 8, !dbg !88
  call void @remove_from_list(%struct.Node_t** %9, %struct.Node_t* %10) nounwind, !dbg !88
  store i32 0, i32* %0, align 4, !dbg !89
  %11 = load i32* %0, align 4, !dbg !89
  store i32 %11, i32* %retval, align 4, !dbg !89
...
!1 = metadata !{i32 589865, metadata !"link-list2.c", metadata !"/home/qirong/Desktop/KLEE_SOURCE/Release+Asserts/bin/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"link-list2.c", metadata !"/home/qirong/Desktop/KLEE_SOURCE/Release+Asserts/bin/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG
