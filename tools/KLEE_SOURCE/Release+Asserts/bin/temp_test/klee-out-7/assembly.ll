...
bb3:                                              ; preds = %bb1
  %7 = icmp sgt i32 %6, 13, !dbg !71
  br i1 %7, label %bb4, label %bb5, !dbg !71

bb4:                                              ; preds = %bb3
  %8 = load i32* %a_addr, align 4, !dbg !72
  store i32 %8, i32* %num3, align 4, !dbg !72
  br label %bb5, !dbg !72

bb5:                                              ; preds = %bb4, %bb3, %bb2
  %9 = load i32* %a_addr, align 4, !dbg !73
  store i32 %9, i32* %0, align 4, !dbg !73
  br label %bb6, !dbg !73

bb6:                                              ; preds = %bb5, %bb
  %10 = load i32* %0, align 4, !dbg !68
  store i32 %10, i32* %retval, align 4, !dbg !68
  %retval7 = load i32* %retval, !dbg !68
  ret i32 %retval7, !dbg !68
}
...
entry:
  ...
  %result = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  store i32 100, i32* %a1, align 4, !dbg !74
  %1 = load i32* %a1, align 4, !dbg !76
  %2 = call i32 @loop(i32 %1) nounwind, !dbg !76
...
!71 = metadata !{i32 13, i32 0, metadata !66, null}
!72 = metadata !{i32 14, i32 0, metadata !66, null}
!73 = metadata !{i32 18, i32 0, metadata !66, null}
!74 = metadata !{i32 28, i32 0, metadata !75, null}
!75 = metadata !{i32 589835, metadata !6, i32 24, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!76 = metadata !{i32 30, i32 0, metadata !75, null}
