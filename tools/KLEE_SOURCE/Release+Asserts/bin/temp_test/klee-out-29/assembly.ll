...
entry:
  ...
  %2 = load i32* %a_addr, align 4, !dbg !65
  %int_cast_to_i64 = zext i32 %1 to i64
  call void @klee_int_overflow_check(i64 %int_cast_to_i64)
  %3 = add nsw i32 %1, %2, !dbg !65
  store i32 %3, i32* %num1, align 4, !dbg !65
  %4 = load i32* %num1, align 4, !dbg !67
  store i32 %4, i32* %0, align 4, !dbg !67
...
declare void @klee_int_overflow_check(i64)
