...
entry:
  ...
  %temp = alloca %struct.Node_t*
  %a1 = alloca %struct.Node_t*
  %"alloca point" = bitcast i32 0 to i32
  %1 = call noalias i8* @malloc(i64 24) nounwind, !dbg !82
  %2 = bitcast i8* %1 to %struct.Node_t*, !dbg !82
  store %struct.Node_t* %2, %struct.Node_t** %temp, align 8, !dbg !82
  store %struct.Node_t** %temp, %struct.Node_t*** %a0, align 8, !dbg !84
  %3 = load %struct.Node_t*** %a0, align 8, !dbg !85
  %4 = load %struct.Node_t** %3, align 8, !dbg !85
  %5 = bitcast %struct.Node_t* %4 to i8*, !dbg !85
  call void @klee_make_symbolic(i8* %5, i64 24, i8* getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !85
  %6 = call noalias i8* @malloc(i64 24) nounwind, !dbg !86
  %7 = bitcast i8* %6 to %struct.Node_t*, !dbg !86
  store %struct.Node_t* %7, %struct.Node_t** %a1, align 8, !dbg !86
  %8 = load %struct.Node_t** %a1, align 8, !dbg !87
  %9 = bitcast %struct.Node_t* %8 to i8*, !dbg !87
  call void @klee_make_symbolic(i8* %9, i64 24, i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !87
  %10 = load %struct.Node_t*** %a0, align 8, !dbg !88
  %11 = load %struct.Node_t** %a1, align 8, !dbg !88
  call void @remove_from_list(%struct.Node_t** %10, %struct.Node_t* %11) nounwind, !dbg !88
  store i32 0, i32* %0, align 4, !dbg !89
  %12 = load i32* %0, align 4, !dbg !89
  store i32 %12, i32* %retval, align 4, !dbg !89
  %retval1 = load i32* %retval, !dbg !89
  ret i32 %retval1, !dbg !89
}
...
!1 = metadata !{i32 589865, metadata !"link-list3.c", metadata !"/home/qirong/Desktop/KLEE_SOURCE/Release+Asserts/bin/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"link-list3.c", metadata !"/home/qirong/Desktop/KLEE_SOURCE/Release+Asserts/bin/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG
...
!86 = metadata !{i32 37, i32 0, metadata !83, null}
!87 = metadata !{i32 38, i32 0, metadata !83, null}
!88 = metadata !{i32 40, i32 0, metadata !83, null}
!89 = metadata !{i32 42, i32 0, metadata !83, null}
