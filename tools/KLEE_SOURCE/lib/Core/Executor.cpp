...
#ifdef MONICA
printf("...Executor::setModul called\n");
#endif
...
//****************************************************Deal with branches in the program********************************************//
    case Instruction::Br: {
...
//*******Added by Monica for test
#ifdef MONICA
//extern int branch_cnt;
printf("forking for new branch #:%d\n", branch_cnt++);
#endif
//**********End Adding
...
//***Question: the concept related to seed is unclear ***//
    if (usingSeeds) {
...
#ifdef MONICA
printf("***Enter Function: executeMakeSymbolic\n");
#endif
...
#ifdef MONICA
printf("...executeMakeSymbolic: name is \"%s\"\n",name.c_str());
#endif

//***Symbolization for each variable, called when klee_make_symbolic() function called***//
    const Array *array = new Array(uniqueName, mo->size);
    bindObjectInState(state, mo, false, array);
    state.addSymbolic(mo, array);

#ifdef MONICA
printf("......executeMakeSymbolic: add symbolic done\n");
#endif
    ...
    if (it!=seedMap.end()) { // In seed mode we need to add this as a
                             // binding.
#ifdef MONICA
printf("......executeMakeSymbolic: in seed mode\n");
#endif
...
#ifdef MONICA
printf("......executeMakeSymbolic: NOT in replay\n");
#endif
...
#ifdef MONICA
printf("***executeMakeSymbolic: Function DONE\n");
#endif
}
...
//*******************Extract Arguments of Main Function ***********************************//
//***Question: why no more than 3 arguments?
