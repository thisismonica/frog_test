...
typedef struct TC_TCB_STRUCT
{
    ...
    UNSIGNED            tc_scheduled_time;     /* Task scheduled time    */
    UNSIGNED            tc_scheduled_time_max; /* Max Task scheduled time */
    long long           tc_run_time;           /* Run Time */
    long long           tc_run_clock;          /* Start run clock */
