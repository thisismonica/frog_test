...
/************************************************************************/
/* Added by Zhou Jingyu for C3X SYSTEM                                  */
/************************************************************************/
#if defined(_C3X)
...
#endif	/* _C3X	*/
/************************************************************************/
/* Added by Zhou Jingyu End                                             */
/************************************************************************/

/************************************************************************/
/* Added by XYS for C6X SYSTEM  暂时定义和C3X相同，以后考虑64位的数据，例如long long  */
/************************************************************************/
#if defined(_C6X)
...
#define ST_CHAR    char	
#define ST_INT     signed int		
#define ST_LONG    signed int     	/* C6X long is 40bits !! */
#define ST_UCHAR   unsigned char	
#define ST_UINT    unsigned int		
#define ST_ULONG   unsigned int     /* C6X long is 40bits !! */
#define ST_VOID    void      		
#define ST_DOUBLE  double		
#define ST_FLOAT   float		
...
#define ST_INT8   signed char     	
#define ST_INT16  signed short     	
#define ST_INT32  signed int    	 	/* C6X long is 40bits !! */
#define ST_INT64  signed long
#define ST_UINT8  unsigned char     	
#define ST_UINT16 unsigned short    	
#define ST_UINT32 unsigned int    	 	/* C6X long is 40bits !! */
#define ST_UINT64 unsigned long
#define ST_BOOLEAN  unsigned char		
...
/************************************************************************/
/* Added by LIJIE for POWERPC SYSTEM                                    */
/************************************************************************/
#if defined(_PPC)
