 ...
 *
 * $Id: yportenv.h,v 1.3 2009/11/09 07:35:38 shenchen Exp $
 *
 */
...
#define CONFIG_YAFFS_NO_YAFFS2 
#define CONFIG_YAFFS_DISABLE_BACKGROUND_DELETION  
#define CONFIG_YAFFS_USE_HEADER_FILE_SIZE 
