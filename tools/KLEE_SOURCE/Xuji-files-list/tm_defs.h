...
typedef struct TM_APP_TCB_STRUCT
{
    ...
    UNSIGNED            tm_scheduled_time;     /* Scheduled time    */
    UNSIGNED            tm_scheduled_time_max; /* Max scheduled time */
    long long           tm_run_time;           /* Run Time */
    long long           tm_run_clock;          /* Start run clock */
} TM_APP_TCB;
