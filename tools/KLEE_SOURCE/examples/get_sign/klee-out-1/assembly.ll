...
entry:
  ...
  %a = alloca i32
  %"alloca point" = bitcast i32 0 to i32
  %1 = call i32 (...)* @klee_make_symbolic(i32* %a, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !71
...
!1 = metadata !{i32 589865, metadata !"get_sign.c", metadata !"/home/kuan/klee/examples/get_sign/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"get_sign.c", metadata !"/home/kuan/klee/examples/get_sign/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
